...
const AboutPage = ()=>{
    ...
    return (
        <div className="w-full h-full ">
           <Header/>
            <div style={{height:"85%"}} className="w-full flex pt-12  bg-slate-100">
                {/* 左边 */}
                <div className=" h-full md:w-1/3 w-1/2 flex flex-col items-center justify-center border-r-2 border-gray-200">
                <div className="md:h-[200px] md:w-[200px] h-[100px] w-[100px] rounded-full border-4 border-white dark:border-dark-3">
            <img
              src={avatar}
              alt="avatar"
      ...
      <div className=" cursor-pointer px-2" onClick={()=>{window.location.href="https://github.com/0xdoomxy"}}>
...
<div className="px-2 ">
<svg xmlns="http://www.w3.org/2000/svg" width="1.5em" height="1.5em" viewBox="0 0 16 16" ><path fill="currentColor" d="M8 .25a.75.75 0 0 1 .673.418l1.882 3.815l4.21.612a.75.75 0 0 1 .416 1.279l-3.046 2.97l.719 4.192a.751.751 0 0 1-1.088.791L8 12.347l-3.766 1.98a.75.75 0 0 1-1.088-.79l.72-4.194L.818 6.374a.75.75 0 0 1 .416-1.28l4.21-.611L7.327.668A.75.75 0 0 1 8 .25"></path></svg>
</div>
<div className=" px-2">
<svg xmlns="http://www.w3.org/2000/svg" width="1.5em" height="1.5em" viewBox="0 0 512 512"><path fill="currentColor" d="M408.67 298.53a21 21 0 1 1 20.9-21a20.85 20.85 0 0 1-20.9 21m-102.17 0a21 21 0 1 1 20.9-21a20.84 20.84 0 0 1-20.9 21m152.09 118.86C491.1 394.08 512 359.13 512 319.51c0-71.08-68.5-129.35-154.41-129.35s-154.42 58.27-154.42 129.35s68.5 129.34 154.42 129.34c17.41 0 34.83-2.33 49.92-7c2.49-.86 3.48-1.17 4.64-1.17a16.67 16.67 0 0 1 8.13 2.34L454 462.83a11.6 11.6 0 0 0 3.48 1.17a5 5 0 0 0 4.65-4.66a14.3 14.3 0 0 0-.77-3.86c-.41-1.46-5-16-7.36-25.27a19 19 0 0 1-.33-3.47a11.4 11.4 0 0 1 5-9.35"></path><path fill="currentColor" d="M246.13 178.51a24.47 24.47 0 0 1 0-48.94c12.77 0 24.38 11.65 24.38 24.47c1.16 12.82-10.45 24.47-24.38 24.47m-123.06 0A24.47 24.47 0 1 1 147.45 154a24.57 24.57 0 0 1-24.38 24.47M184.6 48C82.43 48 0 116.75 0 203c0 46.61 24.38 88.56 63.85 116.53C67.34 321.84 68 327 68 329a11.4 11.4 0 0 1-.66 4.49C63.85 345.14 59.4 364 59.21 365s-1.16 3.5-1.16 4.66a5.49 5.49 0 0 0 5.8 5.83a7.15 7.15 0 0 0 3.49-1.17L108 351c3.49-2.33 5.81-2.33 9.29-2.33a16.3 16.3 0 0 1 5.81 1.16c18.57 5.83 39.47 8.16 60.37 8.16h10.45a133.2 133.2 0 0 1-5.81-38.45c0-78.08 75.47-141 168.35-141h10.45C354.1 105.1 277.48 48 184.6 48"></path></svg>
</div>
                     </div>
                     <div className=" w-full text-center pt-1 ">
                            <p className=" text-sm indent-4 font-normal">We can only see a short distance ahead, but we can see plenty there that needs to be done.</p>
                     </div>
                </div>
                {/* 右边 */}
